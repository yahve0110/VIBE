  ...
  const toggleFilter = (
    ...
    setSelectedFilters((prevFilters) => ({
      ...
      [category]: {
        ...
        [filter as keyof typeof prevFilters[typeof category]]: !prevFilters[
          category
      ...
      <div className="mb-8 flex flex-col text-2xl gap-2 shadow-md w-[300px] p-6 rounded-xl">
        <Link
          ...
          className={`cursor-pointer ${
            isActiveLink("/") ? "text-indigo-700 font-bold" : ""
          }`}
        >
          Dashboard
        </Link>
        <Link
          href="/profile"
          className={`cursor-pointer ${
            isActiveLink("/profile") ? "text-indigo-700 font-bold" : ""
          }`}
        >
          Profile
        </Link>
      ...
      <div className="shadow-md w-[300px] p-6 rounded-xl">
        ...
        <div className="mb-6">
          ...
          <ul className="text-base flex flex-col gap-2">
            {(["fullTime", "partTime", "contract", "remote"] as const).map(
              (type) => (
